  ...
  return {
    ...
    plugins: [
      ...
      figmaSiteConfiguration({
        title: "ClinicHub | Family Clinic",
        description:
          "Book trusted family healthcare with ClinicHub specialists across primary care, dental, pediatrics, dermatology, gynecology, and orthopedics.",
        language: "en",
        robots: { index: true },
